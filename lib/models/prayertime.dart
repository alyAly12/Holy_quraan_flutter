...
import 'dart:convert';
getPray prayerTimeFromJson(String str) => getPray.fromJson(json.decode(str));

String prayerTimeToJson(getPray data) => json.encode(data.toJson());
final prayerTime = prayerTimeFromJson(json.toString());
var decoded= json;
...
class getPray {
  ...
  factory getPray.fromJson(Map<String, dynamic> json) => getPray(
    code: json["code"],
    status: json["status"],
